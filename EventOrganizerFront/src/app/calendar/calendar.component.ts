...
import {DataService} from "./calendar.service";
    ...
    <div class="container">
      ...
      <div class="content">
        <div class="buttons">
          <button
            (click)="viewDay()"
            [class]="this.configNavigator.selectMode == 'Day' ? 'selected' : ''"
          >
            Day
          </button>
          <button
            (click)="viewWeek()"
            [class]="
              this.configNavigator.selectMode == 'Week' ? 'selected' : ''
            "
          >
            Week
          </button>
          <button
            (click)="viewMonth()"
            [class]="
              this.configNavigator.selectMode == 'Month' ? 'selected' : ''
            "
          >
            Month
          </button>
...
export class CalendarComponent implements AfterViewInit, OnInit {
  ...
  loadEvents(): void {
    ...
    this.ds.getEvents(from, to, this.httpOptionsParams).subscribe((result) => {
      this.events = result;
    });
  }
